...
public class AuthExchanger {
    ...
    public CognitoAuthResponse exchangeAuthCodeForTokens(String code, String codeVerifier)
    ...
    public CognitoAuthResponse refreshAccessTokens(String refreshToken)
        throws IOException, InterruptedException {
        var params = CognitoAuthTokenRequest.builder()
            .clientId(ParameterStore.cognitoClientId())
    ...
    private CognitoAuthResponse post(CognitoAuthTokenRequest parameters)
        throws IOException, InterruptedException {
